...
def write_sms_history(pt_data, run_time):
    ...
    print("write_sms_history run")
    print(sms_history_dataframe)
...
def run_ranking(patient, client, run_time):
    ...
    # context becomes a JSON like formatted dictionary that is read into the RankRequest function for further 'formating' same with actions
    context = get_framing_context(patient)
    actions = get_framing_actions()
    
    print("getting info for RankRequest")
    print("actions are:")
    print(actions)
    print("context is:")
    print(context)
    # The RankRequest() function is to create a rankrequest object that is formatted for the personalizer client input
    frame_rank_request = RankRequest(actions=actions, context_features=context, event_id=rank_id_framing)
    
    print("Rankrequest generated. Object is:")
    print(frame_rank_request)
    
    # sends rank request to the personalizer client (i.e. connection occurs here)
    frame_response = client.rank(rank_request=frame_rank_request) 
   
   # frame_response object holds the reward choice that personalizer chose for this patient, 
   # # then later we save that response far below
  
    print("Printing reward choice aka/frame response:")
    print(frame_response)
  
   # this framing_ranked thing is probably just an ID string unique to think rank and reward call 
   
   # this 'reward action id' will be needed when you want to tell personalizer
   # hey this is what ultimately happened based on that suggestion
    framing_ranked = frame_response.reward_action_id
    
    print("Framing ranked, which is what ultimately happened for the suggestion")
    print(framing_ranked)
    
    # lily made function to store new personalizer chosen decision to our row of data
    patient = update_framing_ranking(patient, framing_ranked)
    print("ran update_framing_ranking, should be the second print")
    print(patient)
    ...
    print("ran update_history_ranking, should be the second print")
    print(patient)
    # [framing, history, social, content, reflective]
    # [0,1,1,0,1] = a specific text message to send
    # social
    ...
    print("Got social ID ranks")
    print(rank_id_social)
    ...
    print("Got social rank request")
    print(social_rank_request)

    patient = update_social_ranking(patient,social_ranked)
    
    print("Re-printing update_social_ranking output")
    print(patient)
    ...
    print("Got content ID ranks")
    print(rank_id_content)
    ...
    print("Re-printing update_content_ranking output")
    print(patient)
    ...
    print("Re-printing update_reflective_ranking output")
    print(patient)
    ...
    print("Saving dataframes from outputs....")
    # this is where we save the reward chosen for each rank request we sent
    #Framing
    ...
    print("Printing framing dataframe")
    print(frame_response)
    ...
    print("Printing history dataframe")
    ...
    print("Printing social dataframe")
    ...
    print("Printing content dataframe")
    ...
    print("Printing reflective dataframe")
    ...
    print("run_ranking run, will print 2 variables")
    print(patient)
    print(pt_rank_log)
...
def shift_t0_t1_rank_ids(patient):
    ...
    print("shift_t0_t1_rank_ids run")
    print(patient)
    return patient
...
def update_framing_ranking(patient, response_action_id_framing):
    ...
    print("update_framing_ranking run")
    print(patient)
    return patient
...
def update_history_ranking(patient, response_action_id_history):
    ...
    print("update_history_ranking run")
    print(patient)
    return patient
...
def update_social_ranking(patient, response_action_id_social):
    ...
    print("update_social_ranking run")
    print(patient)
    return patient
...
def update_content_ranking(patient, response_action_id_content):
    ...
    print("update_content_ranking run")
    print(patient)
    return patient
...
def update_reflective_ranking(patient, response_action_id_reflective):
    ...
    print("update_reflective_ranking run")
    print(patient)
    return patient
...
def get_demographics_features(patient):
    ...
    print("updated_sms_today run")
    print(demographic_features_dict)
...
def get_clinical_features(patient):
    ...
    print("get_clinical_features run")
    print(clinical_features_dict)
...
def get_motivational_features(patient):
    ...
    print("get_motivational_features run")
    print(motivational_features_dict)
...
def get_pillsy_med_features(patient):
    ...
    print("get_pillsy_med_features run")
    print(pillsy_med_features_dict)
...
def get_observed_feedback_features(patient):
    ...
    print("get_observed_feedback_features run")
    print(observed_feedback_features_dict)
...
def get_num_days_since_features(patient):
    ...
    print("get_num_days_since_features run")
    print(num_days_since_features_dict)
...
def get_framing_context(patient):
    ...
    print("get_framing_context run")
    print(framing_context)
...
def get_reflective_context(patient):
    ...
    print("get_reflective_context run")
    print(reflective_context)
