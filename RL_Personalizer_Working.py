...
#from nudge_parser import import_nudge, update_nudge_data
...
#from: patient_data.py
pt_data = import_pt_data(run_time)
#from: control_disconnection
...
if not pt_data.empty and new_pillsy_data is not None:
    ...
    # THIS IS WHERE IT APPEARS TO BE BREAKING
    pt_data = find_rewards(new_pillsy_data, pt_data, run_time)
    # specifically like 357 in pillsy_parser
    # back to 
